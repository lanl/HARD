...
# 'CatalystAdaptor'. (auto channel = exec_params["catalyst/channels/grid"];)
...
densityLUT.RGBPoints = [0.0, 0.231373, 0.298039, 0.752941, 29.205000000000002, 0.865003, 0.865003, 0.865003, 58.410000000000004, 0.705882, 0.0156863, 0.14902]
...
gridDisplay.ColorArrayName = ['CELLS', 'density']
gridDisplay.LookupTable = densityLUT
...
pNG1.Writer.FileName = 'screenshot_{timestep:06d}.density.png'
pNG1.Writer.ImageResolution = [1200,800]
