...
set terminal png
set output "output-XXXXX-2D-0.raw.png"
unset clip points
set clip one
unset clip two
...
set zrange [ * : 1.0 ] noreverse writeback
set cblabel "" 
...
GNUTERM = "qt"
## Last datafile plotted: "output-00050-2D-0.raw"
splot 'output-XXXXX-2D-0.raw' u ($2/YYYYY):($3/YYYYY):CCCCC w pm3d at bs title 'flastro 2D, YYYYY cells, t = ZZZZZ'
#    EOF
