...
//
// Problem domain is [0, 0.3]^2. In the region x + y < 0.15, density=0.125 and
// pressure=0.14. Otherwise denisty and pressure both 1.0. Initial velocity is
// zero everywhere.
//
